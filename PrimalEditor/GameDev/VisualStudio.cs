        ...
        public static void OpenVisualStudio(string solutionPath)
        {
            ...
            try
            {
                if (_vsInstance == null)
                {
                    ...
                    if (hResult < 0 || bindCtx == null) throw new COMException($"GetRunningObjectTable() returned HRESULT: {hResult:X8}");
            ...
            catch (Exception ex)
            {
                ...
                Logger.Log(MessageType.Error, "Failes to Open Visual Studio");
            }
