...
namespace PrimalEditor.GameProject
{
	...
	class Project : ViewModelBase
	{
		...
		public ICommand DebugStartWithDebuggingCommand { get; private set; }
		...
		private void SetCommands()
		{
			...
			DebugStartWithDebuggingCommand = new RelayCommand<object>(async x => await RunGame(false), x => !VisualStudio.IsDebugging() && VisualStudio.BuildDone);
			...
			OnPropertyChanged(nameof(DebugStartWithDebuggingCommand));
